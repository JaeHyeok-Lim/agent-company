...
lives at `.claude/state/allocation.json` (gitignored) and drives the dashboard's planned-count
display.
...
## Current plan
_(none yet — run `staffed-build` or ask the chief-of-staff to staff a goal)_
