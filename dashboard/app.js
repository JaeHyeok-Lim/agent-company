...
if (buildTag) buildTag.textContent = 'build · ⚖️ legal role added (15 roles)'; // bump to confirm a hard refresh loaded new code
...
const ROLE_NAME = {
  ko: { ceo: '대표(You)', orchestrator: '총괄', 'chief-of-staff': '관리팀', 'product-manager': '기획팀', researcher: '조사팀', designer: '디자인팀', architect: '설계팀', implementer: '개발팀', devops: '데브옵스', reviewer: '검토팀', security: '보안팀', legal: '법무팀', 'data-analyst': '데이터팀', scribe: '문서팀', auditor: '감사팀' },
  en: { ceo: 'You (CEO)', orchestrator: 'Orchestrator', 'chief-of-staff': 'Management', 'product-manager': 'Product', researcher: 'Research', designer: 'Design', architect: 'Architecture', implementer: 'Engineering', devops: 'DevOps', reviewer: 'Review', security: 'Security', legal: 'Legal', 'data-analyst': 'Data', scribe: 'Docs', auditor: 'Audit' },
};
const ROLE_ACTION = {
  ko: { ceo: '지시', orchestrator: '총괄', 'chief-of-staff': '업무 배정', 'product-manager': '요구사항 정의', researcher: '자료 조사', designer: 'UX 설계', architect: '설계', implementer: '개발', devops: '배포·인프라', reviewer: '검토', security: '보안 점검', legal: '법률·규정 검토', 'data-analyst': '데이터 분석', scribe: '문서화', auditor: '점검' },
  en: { ceo: 'directing', orchestrator: 'coordinating', 'chief-of-staff': 'assigning', 'product-manager': 'defining specs', researcher: 'researching', designer: 'designing UX', architect: 'architecting', implementer: 'building', devops: 'deploying', reviewer: 'reviewing', security: 'security review', legal: 'compliance review', 'data-analyst': 'analyzing', scribe: 'writing docs', auditor: 'auditing' },
};
const OUTPUT = { // the abstract thing a sender hands off (shown on the plane)
  ko: { ceo: '지시', orchestrator: '지시', 'chief-of-staff': '업무 배정', 'product-manager': '요구사항', researcher: '조사 결과', designer: '디자인 시안', architect: '설계안', implementer: '구현물', devops: '배포본', reviewer: '검토 의견', security: '보안 검토', legal: '법률 검토', 'data-analyst': '분석 결과', scribe: '문서', auditor: '개선 제안' },
  en: { ceo: 'brief', orchestrator: 'brief', 'chief-of-staff': 'assignment', 'product-manager': 'spec', researcher: 'findings', designer: 'mockups', architect: 'design', implementer: 'build', devops: 'release', reviewer: 'review', security: 'sec review', legal: 'compliance memo', 'data-analyst': 'analysis', scribe: 'docs', auditor: 'proposal' },
};
...
const NEXT = {
  ...
  security: 'legal', legal: 'scribe', scribe: 'orchestrator', 'data-analyst': 'orchestrator', 'chief-of-staff': 'orchestrator',
};
